  ...
  drawSpreadBar(my_spread,svg_middle_y,y_coordinate, offset, id){
    ...
    updateBidAndAsk(FPCDollarAmount){
        if(document.querySelector("info-table").player_role == "MAKER"){
            ...
            document.querySelector('info-table').curr_bid = (FPCDollarAmount + spread_value).toFixed(2);
            document.querySelector('info-table').curr_ask = (FPCDollarAmount - spread_value).toFixed(2);
        }
    }
