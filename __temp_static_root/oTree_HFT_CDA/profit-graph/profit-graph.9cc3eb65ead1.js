...
.my-negative-profit {
    ...
    Profit_Graph.profit = Profit_Graph.startingWealth;                                           // Through Django Channels
    Profit_Graph.adminStartTime = oTreeConstants.admin_start_time;           // Django Query
    ...
    Profit_Graph.profitSegments = [
        {
            ...
            state:document.querySelector('info-table').getAttribute("player_role")
        }
    ];
    ...
    /*
    Functionc tied to the Profit Graph
    */
    ...
    this.init(oTreeConstants.startFP, Profit_Graph.startingWealth, "secondTick");
