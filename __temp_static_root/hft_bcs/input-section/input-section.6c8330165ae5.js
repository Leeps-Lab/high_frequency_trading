    ...
    <div class="row">
        <div class="text-center col-lg-3">
            ...
            <div style="margin-top:25px;">
                <button  value="out" class="text-center btn btn-success" on-click="submitSensitivities" type="button">Submit Values</button>
            </div>
        </div>
        <div class="text-center col-lg-3" >
            <button  value="out" class="text-center btn btn-primary algorithm-button" on-click="algoA" type="button">Algorithm A</button>
            <div style="margin-top:25px;">
        ...
        <div class="text-center col-lg-3">
            <button value="out" class="text-center btn btn-primary algorithm-button" on-click="algoB" type="button">Algorithm B</button>
            <div style="margin-top:25px;">
