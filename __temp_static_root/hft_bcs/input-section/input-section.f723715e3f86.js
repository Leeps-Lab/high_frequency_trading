...
<br>
  ...
  constructor() {
    ...
    if(otreeConstants.FBA){
        ...
        inputSection.inputWidth = inputSection.shadow_dom.querySelector("#timer_FBA").clientWidth;
        inputSection.inputHeight = inputSection.shadow_dom.querySelector("#timer_FBA").clientHeight;
        ...
        console.log("inputWidth = " +  inputSection.inputWidth + ", inputHeight = " + inputSection.inputHeight + ", inputX = " + inputSection.inputX + ", inputY = " + inputSection.inputY);
  ...
  drawTimer(){
    ...
    inputSection.timerSVGDOM.style.marginLeft = "50%";
    inputSection.timerSVGDOM.style.backgroundColor = "lightgrey";
    console.log(document);
    var timerBackgroundLine = inputSection.timerSVG.append("svg:line")
                       .attr("x1", inputSection.inputX)
                       .attr("y1", inputSection.inputHeight)
                       .attr("x2", inputSection.inputX + inputSection.inputWidth)
                       .attr("y2", inputSection.inputHeight)
                       .style("stroke", "black")
