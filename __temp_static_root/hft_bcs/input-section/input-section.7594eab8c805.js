  ...
  activateButtons(){
    ...
    uncheckOtherButtons(button){
        ...
        if(button.className.includes("manual-button")){
            inputSection.inputSectionShadowDOM.querySelector(".maker-button").className.replace("btn-success","btn-primary");
            inputSection.inputSectionShadowDOM.querySelector(".taker-button").className.replace("btn-success","btn-primary");
            inputSection.inputSectionShadowDOM.querySelector(".out-button").className.replace("btn-success","btn-primary");
    
        } else if(button.className.includes("maker-button")){
            inputSection.inputSectionShadowDOM.querySelector(".manual-button").className.replace("btn-success","btn-primary");
            inputSection.inputSectionShadowDOM.querySelector(".taker-button").className.replace("btn-success","btn-primary");
            inputSection.inputSectionShadowDOM.querySelector(".out-button").className.replace("btn-success","btn-primary");
