  ...
  activateButtons(){
    ...
    uncheckOtherButtons(button){
        ...
        if(button.className.includes("manual-button")){
            inputSection.inputSectionShadowDOM.querySelector(".maker-button").className.remove("btn-success");
            inputSection.inputSectionShadowDOM.querySelector(".taker-button").className.remove("btn-success");
            inputSection.inputSectionShadowDOM.querySelector(".out-button").className.remove("btn-success");
            ...
            inputSection.inputSectionShadowDOM.querySelector(".manual-button").className.remove("btn-success");
            inputSection.inputSectionShadowDOM.querySelector(".taker-button").className.remove("btn-success");
            inputSection.inputSectionShadowDOM.querySelector(".out-button").className.remove("btn-success");
