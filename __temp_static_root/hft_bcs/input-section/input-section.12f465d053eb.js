...
<br>
  ...
  drawTimer(){
    ...
    inputSection.timerLine = inputSection.timerSVG.append("svg:line")
                                                .attr("x1", 0)
                                                .attr("y1", 0)
                                                .attr("x2", 0)
                                                .attr("y2", 0)
                                                .attr("class","timer-line")
                                                .style("stroke", "purple")
                                                .style("stroke-width", 10);
  }

  startTimer(){
    inputSection.timerLine.attr("x2", 0);
    inputSection.timerLine.transition()
            .duration(otreeConstants.batchLength*1000)
