  ...
  constructor() {
    ...
    <div class="row">
        <div class="text-center col-lg-3">
            <button  value="out" class="text-center btn btn-lg btn-primary manual-button" type="button"  width="80px">Manual</button>
        ...
        <div class="text-center col-lg-3" >
            <button class="text-center btn btn-lg btn-primary algorithm-button maker-button" type="button"  width="80px">Maker</button>
            <div class="slider-sens" style="margin-top:50px;">
        ...
        <div class="text-center col-lg-3">
            <button class="text-center btn btn-lg btn-primary taker-button taker-button" type="button" width="80px">Taker</button>
            <div class="slider-sens" style="margin-top:50px;">
        ...
        <div class="text-center col-lg-3">
            <button class="text-center btn btn-lg btn-primary out-button" type="button" width="80px">Out</button>
