...
<div class="row">
    <div class=" col-lg-3" style="border:solid black 1px;">
        <button  value="out" class="text-center btn btn-primary" on-click="outClick" type="button">Manual Order Submit</button>
        <br>
        <input type="range" min="-1" max="1" value="0" class="slider" id="myRange">
    </div>
    <div class=" col-lg-3" style="border:solid black 1px;">
