...
<div class="row">
    <div class=" col-lg-3">
        <button id="out" value="out" class="text-center btn btn-primary" on-click="outClick" type="button">Manual Order Submit</button>
        <br>
        <button id="out" value="out" class="text-center btn btn-primary" on-click="outClick" type="button">Commit Sensitivities</button>
    </div>
    <div class=" col-lg-3">
        <button id="out" value="out" class="text-center btn btn-primary" on-click="outClick" type="button">Algorithm A</button>
        <br>
        <br>
    ...
    <div class=" col-lg-3">
        <button id="out" value="out" class="text-center btn btn-primary" on-click="outClick" type="button">Algorithm B</button>
        <br>
        <br>
        <input id="ex4" type="text" data-slider-min="-5" data-slider-max="20" data-slider-step="1" data-slider-value="-3" data-slider-orientation="vertical"/>
    </div>
