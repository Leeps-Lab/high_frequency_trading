...
<br>
  ...
  constructor() {
    ...
    if(otreeConstants.FBA){
        inputSection.shadow_dom_D3.append("br");
        inputSection.timerSVG = inputSection.shadow_dom_D3.append("svg")
                                .attr("id","timer");
        inputSection.timerSVGD3 = d3.select(inputSection.shadow_dom_D3.querySelector("#timer"));
  ...
  drawTimer(){
    inputSection.timerSVGD3.style.width = inputSection.inputWidth;
    console.log(document);
    var timerBackgroundLine = inputSection.timerSVGD3.append("svg:line")
