...
<div class="row">
    ...
    <div class=" col-xs-3">
        <button id="sniper" value="sniper" class="button-off col-xs-3" on-click="sniperClick" type="button" style="width:80px">Sniper</button> 
    </div>
    <div class=" col-xs-3">
        <button id="maker" value="maker" class="button-off col-xs-3" on-click="makerClick" type="button" style="width:80px">Maker</button>
    </div>
    <div class=" col-xs-3">
