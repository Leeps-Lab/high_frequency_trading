  ...
  activateButtons(){
    ...
    uncheckOtherButtons(button){
        ...
        if(button.className.includes("manual-button")){
            inputSection.inputSectionShadowDOM.querySelector(".maker-button").className.toggle("btn-success");
            inputSection.inputSectionShadowDOM.querySelector(".taker-button").className.toggle("btn-success");
            inputSection.inputSectionShadowDOM.querySelector(".out-button").className.toggle("btn-success");
            ...
            inputSection.inputSectionShadowDOM.querySelector(".manual-button").className.toggle("btn-success");
            inputSection.inputSectionShadowDOM.querySelector(".taker-button").className.toggle("btn-success");
            inputSection.inputSectionShadowDOM.querySelector(".out-button").className.toggle("btn-success");
