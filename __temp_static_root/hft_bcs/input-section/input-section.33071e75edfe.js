...
<div class="row">
    <div class=" col-xs-3">
        <button id="out" value="out" class="btn btn-primary" on-click="outClick" type="button">Manual Order Submit</button>
    </div>
    <div class=" col-xs-3">
        <button id="out" value="out" class="btn btn-primary" on-click="outClick" type="button">Algorithm A</button>
    </div>
    <div class=" col-xs-3">
    <button id="out" value="out" class="btn btn-primary" on-click="outClick" type="button">Algorithm B</button>
    </div>
    <div class=" col-xs-3">
        <p style="text-align: center; font-size:16px; margin-left: 50%; margin-top:40px;">Speed</p>
        <label class="switch" style="margin-left: 50%; margin-top: -10px;" >
