...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js" integrity="sha384-ChfqqxuZUCnJSK3+MXmPNIyE6ZbWh2IMqE241rYiqJxyMiZ6OW/JmZQ5stwEULTy" crossorigin="anonymous"></script>
  ...
  activateSliders() {
        ...
        var sens1 = inputSection.inputSectionShadowDOM.getElementById("sens_1");
        
        var sens1Output = inputSection.inputSectionShadowDOM.getElementById("sens_1_output");
        var sens2 = inputSection.inputSectionShadowDOM.getElementById("sens_2");
        console.log(inputSection.inputSectionShadowDOM);
        var sens2Output = inputSection.inputSectionShadowDOM.getElementById("sens_2_output");
