...
class InputSection extends PolymerElement {
  ...
  constructor() {
    ...
    <div class="row">
        <div class="text-center col-lg-3" style="border:solid black 1px;">
            ...
            <button  value="out" class="text-center btn btn-success" on-click="outClick" type="button">Submit Sensitivities</button>
        </div>
        <div class="text-center col-lg-3" style="border:solid black 1px;">
    ...
    console.log( inputSection.inputSectionShadowDOM);
  ...
  activateSliders() {
        ...
        var sens1 = interactiveComponent.inputSectionDOM.querySelector("#sens_1");
        
        var sens1Output = interactiveComponent.inputSectionDOM.querySelector("#sens_1_output");
        var sens2 = interactiveComponent.inputSectionDOM.querySelector("#sens_2");
        console.log(interactiveComponent.inputSectionDOM.querySelector("input-section"));
        console.log(sens1);
        console.log(sens2);
