...
class InputSection extends PolymerElement {
  ...
  constructor() {
    ...
    <div class="row">
        <div class="text-center col-lg-3">
            ...
            <div style="margin-top:25px;">
                <button  value="out" class="text-center btn btn-success submit-button" on-click="submitSensitivities" type="button">Submit Values</button>
            </div>
        </div>
        <div class="text-center col-lg-3" >
            <button  value="out" class="text-center btn btn-primary algorithm-button algorithm1-button" type="button">Algorithm A</button>
            <div style="margin-top:25px;">
        ...
        <div class="text-center col-lg-3">
            <button value="out" class="text-center btn btn-primary algorithm-button algorithm2-button" type="button">Algorithm B</button>
            <div style="margin-top:25px;">
    ...
    this.activateButtons().bind(this);
  ...
  activateButtons(){
    ...
    manualButton.onclick = this.manualClick;
    algo1Button.onclick = this.algo1Button;
    algo2Button.onclick = this.algo2Button;
    ...
    manualClick(){
        ...
        if(spreadGraph.bidArrow["bidArrowLine"] && spreadGraph.askArrow["askArrowLine"] == undefined){
