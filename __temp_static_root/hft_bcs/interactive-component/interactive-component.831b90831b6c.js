...
`;
spreadGraph.spread_width = interactiveComponent.interactiveComponentShadowDOM.querySelector("interactive-component").clientWidth;
spreadGraph.spread_height = interactiveComponent.interactiveComponentShadowDOM.querySelector("interactive-component").querySelector("#spread-graph-container").clientHeight;

console.log(spreadGraph.spread_width);
