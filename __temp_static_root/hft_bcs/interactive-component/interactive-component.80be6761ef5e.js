...
//     //spreadGraph.mapSpreadGraph();
  ...
  startInteractiveComponent(){
    ...
    interactiveComponent.interactiveComponentShadowDOM.querySelector("spread-graph").attachShadow({mode: 'open'});
    interactiveComponent.interactiveComponentShadowDOM.querySelector("input-section").attachShadow({mode: 'open'});
    console.log(interactiveComponent.interactiveComponentShadowDOM);
