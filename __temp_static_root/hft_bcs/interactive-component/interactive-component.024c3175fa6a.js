...
//     //spreadGraph.mapSpreadGraph();
  ...
  startInteractiveComponent(){
    ...
    interactiveComponent.spreadGraphShadowDOM = interactiveComponent.interactiveComponentShadowDOM.querySelector("spread-graph");
    interactiveComponent.spreadGraphShadowDOM.attachShadow({mode: 'open'});

    interactiveComponent.inputSectionShadowDOM = interactiveComponent.interactiveComponentShadowDOM.querySelector("input-section");
    interactiveComponent.inputSectionShadowDOM.attachShadow({mode: 'open'});
