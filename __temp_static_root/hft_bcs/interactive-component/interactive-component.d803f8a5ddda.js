...
`;
spreadGraph.spread_width = interactiveComponent.interactiveComponentShadowDOM.querySelector("#spread-graph-container").clientWidth;
spreadGraph.spread_height = interactiveComponent.interactiveComponentShadowDOM.querySelector("#spread-graph-container").clientHeight;
console.log(spreadGraph.spread_width,spreadGraph.spread_height );
