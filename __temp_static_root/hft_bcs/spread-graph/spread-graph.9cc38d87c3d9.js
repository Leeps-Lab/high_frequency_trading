...
class SpreadGraph extends PolymerElement {
  constructor() {
    ...
    spreadGraph.spread_width = interactiveComponent.interactiveComponentDOM.clientWidth;
    spreadGraph.spread_height = interactiveComponent.interactiveComponentDOM.clientHeight;
