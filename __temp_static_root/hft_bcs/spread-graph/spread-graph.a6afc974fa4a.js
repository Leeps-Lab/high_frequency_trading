  ...
  */
  ...
  listen(){
    ...
    drawLineAttempt(y_coordinate){
        ...
        .attr("stroke-width",3)
        .attr("class","my_line my_line_attempt");
    ...
    var your_spread_line_bottom = spreadGraph.spread_svg.append("svg:line")
        ...
        your_spread_line_top.transition().delay(transaction_speed*10).remove();
        your_spread_line_bottom.transition().delay(transaction_speed*10).remove();
    }
