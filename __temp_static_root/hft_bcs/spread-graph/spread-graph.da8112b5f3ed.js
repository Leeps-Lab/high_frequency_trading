  ...
  */
  ...
  start(){
    ...
    var priceLine = spreadGraph.spread_svg.append("svg:line")
                       .attr("x1", 0)
                       .attr("y1", spreadGraph.spread_height/4)
                       .attr("x2", spreadGraph.spread_width)
                       .attr("y2", spreadGraph.spread_height/4)
    ...
    // Grey Line in the middle of the spread graph
    var bottomPointerInputLine = spreadGraph.spread_svg.append("svg:line")
                       .attr("x1",0)
                       .attr("y1", spreadGraph.spread_height)
                       .attr("x2", spreadGraph.spread_width)
