...
<marker
  ...
  refY="6"
  orient="auto">
  <path d="M2,2 L10,6 L2,10 L2,2 L2,2" class="unconfirmed-order"></path>
</marker>
<marker
  id="askArrow"
  markerUnits="strokeWidth"
...
// <svg id="timer"></svg>
  ...
  */
  ...
  confirmArrow(arrowLine,arrowText,side){

    if(side == "ask"){
        arrowLine.attr("class","arrow confirmed-bid");
        arrowText.attr("class","arrow price-grid-line-text confirmed-bid");
