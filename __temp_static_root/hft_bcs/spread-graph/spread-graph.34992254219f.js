...
// <svg id="timer"></svg>
  ...
  */
  ...
  animateBBOShift(desiredCenter){
    ...
    bestOfferCicle.transition()
                 .duration(300)
                 .attr("cx", ((desiredCenter < spreadGraph.spread_width/2) ? +bestOfferCicle.attr("cx") - differenceFromMid : +bestOfferCicle.attr("cx") + differenceFromMid))
