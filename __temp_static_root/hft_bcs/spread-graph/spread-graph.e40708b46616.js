    ...
    if(otreeConstants.endMsg == "off"){
        ...
        for(var key in lineParser){
            ...
            if(key==player_id){
                ...
                if(exec.player != player_id || exec.side != "S"){
                    console.log(exec.player + " line top");
                ...
                } else if(exec.player == player_id && exec.side == "S") {
                    exec_side = "S";
                    exec_spread = my_spread;
                }
                
                if(exec.player != player_id || exec.side != "B"){   
                    console.log(exec.player + " line bottom");
        ...
        for(var key in newLines){
                    if(key == player_id){
                        ...
                        if(role == "MAKER"){
                            ...
                            } else if(newLines[key]["TOK"][4] == "B" && exec.player == player){
                                //nn
                            }else{
                ...
                var spread_line_fundamental_price = spreadGraph.spread_svg.append("svg:line")
                    ...
                    .style("stroke-width", 3);
                    window.setTimeout(function(){
                        spreadGraph.spread_svg.select(spread_line_fundamental_price).remove();
                    },400);
