...
// <svg id="timer"></svg>
  ...
  */
  ...
  drawBidArrow(obj){
    // console.log(obj);
    // confirmArrow(obj);
    spreadGraph.bidArrow["bidArrowLine"].transition().duration(100).attr("x1", spreadGaph.visibleTickLines[obj["price"]]).attr("x2", spreadGaph.visibleTickLines[obj["price"]]);
    spreadGraph.bidArrow["bidArrowText"].transition().duration(100).attr("x", spreadGaph.visibleTickLines[obj["price"]] - 10);
  }

  drawOfferArrow(obj){
    console.log(obj);
    spreadGraph.askArrow["askArrowLine"].transition().duration(100).attr("x1", spreadGaph.visibleTickLines[obj["price"]]).attr("x2", spreadGaph.visibleTickLines[obj["price"]]);
    spreadGraph.askArrow["askArrowText"].transition().duration(100).attr("x", spreadGaph.visibleTickLines[obj["price"]] - 10);
