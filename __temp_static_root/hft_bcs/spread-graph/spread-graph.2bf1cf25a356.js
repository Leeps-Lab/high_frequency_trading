...
<marker
  ...
  refY="0"
  orient="auto">
  <path d="M2,2 L10,6 L2,10 L6,6 L2,2" style="fill: #B2D8B2;"></path>
</marker>
<marker
  id="askArrow"
  markerUnits="strokeWidth"
  ...
  refY="0"
  orient="auto">
  <path d="M2,2 L10,6 L2,10 L6,6 L2,2" style="fill: #FFB2B2;"></path>
</marker>
</defs>
</svg>
  ...
  */
  ...
  drawArrows(){
    ...
    spreadGraph.bidArrow["bidArrowLine"] = spreadGraph.spread_svg.append("line")
        ...
        .attr("y1",spreadGraph.spread_height*6 + 10 )  
    ...
    spreadGraph.bidArrow["askArrowLine"]  = spreadGraph.spread_svg.append("line")
    ...
    */
    ...
    //     }
        ...
        for(var temp = lowerBound; temp <= upperBound; temp+=increment){
                visibleTickLines[temp] = xCoordinate;
                spreadGraph.spread_svg.append("svg:line")
                    .attr("x1", xCoordinate)
