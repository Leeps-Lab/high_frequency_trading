...
//   }
  ...
  removeArrows(){
    console.log("THIS");
    d3.select(spreadGraph.bidArrow["bidArrowLine"]).remove();
    d3.select(spreadGraph.askArrow["askArrowLine"]).remove();
    d3.select(spreadGraph.bidArrow["bidArrowText"]).remove();
    d3.select(spreadGraph.askArrow["askArrowText"]).remove();
  }
