...
//   }
  ...
  drawArrows(){
    ...
    spreadGraph.askArrow["askArrowLine"] = spreadGraph.spread_svg.append("line")
        ...
        .call(d3.drag()
            .on("drag", function(){
                ...
                spreadGraph.askArrow["askArrowText"].attr("x1", lineXAsk);
            ...
            .on("end", function(){
                    ...
                    */
                   spreadGraph.askArrow["askArrowText"].attr("x1", checkedXAsk);
    ...
    spreadGraph.askArrow["askArrowText"]  = spreadGraph.spread_svg.append("text")
        ...
        .attr("x", +spreadGraph.bidArrow["bidArrowLine"].attr("x1") )  
