  ...
  */
  ...
  executionHandler(exec = {}){
    ...
    if(otreeConstants.endMsg == "off"){
        ...
        var exec_side =(exec.side == "S") ? "A" : exec.side;
        var exec_spread = "";
        var offset = 0;
        ...
        if(exec.player == userPlayerID){
            ...
            if(spreadGraph.spread_lines[userPlayerID] != undefined){
                ...
                var priceOfTransaction = spreadGraph.spread_lines[exec.player][exec_side];
                ...
                if(exec_side == "B"){
                    ...
                    //     console.log("B");
                    //  console.log(yourSpreadLineBottom);
                ...
                spreadGraph.drawTransactionBar(exec_spread, svgMiddleY,transactionYCoordinate , exec_side, ((exec.profit > 0) ? "transaction_bar_light_green" : "transaction_bar_light_red"), 10);
            } else {
