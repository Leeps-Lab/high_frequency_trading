  ...
  */
  ...
  removeOrder(TOK){
    ...
    for(var i = 0; i < spreadGraph.orderD3Objects.length; i++){
        console.log(spreadGraph.orderD3Objects[i][0]);
        var index = spreadGraph.orderD3Objects[i][0].classList.indexOf(TOK);
        if(index != -1){
  ...
  drawBidArrow(obj){
    console.log(spreadGraph.bidArrow["bidArrowLine"].attr("x1"));
