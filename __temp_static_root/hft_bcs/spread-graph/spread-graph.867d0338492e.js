...
// <svg id="timer"></svg>
  ...
  */
  ...
  BBOShift(shiftMsg){
    ...
    var smallerX = (bestBidCircle.attr("cx") <=  bestOfferCicle.attr("cx")) ? bestBidCircle.attr("cx") : bestBidCircle.attr("cx");
  ...
  drawBestBid(obj){
        ...
        console.log("Circle being drawn at " + bidX);
  ...
  drawBestOffer(obj){
    ...
    console.log("Circle being drawn at " + offerX);
    spreadGraph.spread_svg.append("circle")
        .attr("cx", offerX)
        .attr("cy", spreadGraph.spread_height*0.3)
        .attr("r", 10)
